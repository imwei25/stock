...
**核心结论**:
1. **alpha=0.0005 win:真实、全期稳健、近年仍强** — 修正 harness 下点估计 +0.0064(原 +0.0088,
   −27%),CI 排 0,2021+ 段贡献显著。**维持 promote。**
2. **因子集 win:时间集中,近 5.5 年无增益** — 全期 +0.0075 由 2011-2020 段贡献,2021+ 段
   old→new 为 −0.0039(ns)。且 holdout 检验显示现池对 2021+ 的 +0.0094 优势与"选池时看过
   2021+"的偏差量级一致。**"+18.5% ΔIC"对未来的诚实预期应大幅折价;是否保留 selection.json
   切换待 old@5e4 对照(在跑)后定。**
